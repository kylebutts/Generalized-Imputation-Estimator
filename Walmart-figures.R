...
qld_retail = fread(here("data/factor_est_retail_YEARS_1977_1999_T0_1985_B_1000_p_2.csv"))
qld_retail = as.matrix(qld_retail)
qld_wholesale = fread(here("data/factor_est_wholesale_YEARS_1977_1999_T0_1985_B_1000_p_1.csv"))
...
## did2s -----------------------------------------------------------------------
did2s_retail = fread(here("data/did2s_est_retail_YEARS_1977_1999_T0_1985_B_1000.csv"))
did2s_wholesale = fread(here("data/did2s_est_wholesale_YEARS_1977_1999_T0_1985_B_1000.csv"))
...
pca_retail = fread(here("data/pca_est_retail.csv"))
pca_wholesale = fread(here("data/pca_est_wholesale.csv"))
...
cce_retail = fread(here("data/cce_est_retail.csv"))
cce_wholesale = fread(here("data/cce_est_wholesale.csv"))
