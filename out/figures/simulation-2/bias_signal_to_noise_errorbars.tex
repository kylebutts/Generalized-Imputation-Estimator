% Created by tikzDevice version 0.12.6 on 2025-04-07 20:32:36
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.33] at (537.05,103.16) {TWFE with $\bm{w}_i' \bm{\beta}_t$};
\end{scope}
\end{tikzpicture}
