...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.75\textwidth}
    ...
    \begin{adjustbox}{width=\textwidth, center}
      \includegraphics{plot_did2s_retail.pdf}
    \end{adjustbox}
  \end{subfigure}
  \end{center}
  \begin{center}
  \begin{subfigure}[b]{0.75\textwidth}
    ...
    \begin{adjustbox}{width=\textwidth, center}
      \includegraphics{plot_qld_retail.pdf}
    \end{adjustbox}
  \end{subfigure}
  \end{center}
...
\begin{figure}
  ...
  \note{This figure plots point estimates and bootstrapped 95\% confidence intervals for event-study treatment effects on $\log$ wholesale retail employment. Panel (a) estimates effects using the TWFE imputation estimator proposed in \citet{Borusyak_Jaravel_Spiess_2021}. Panel (b) estimates effects using the generalized imputation estimator we propose in Section \ref{sec:estimation} with $p = 1$ and using the following instruments: 1980 share of population employed in manufacturing, 1980 shares of population below and above poverty line; 1980 shares of population employed in private-sector and by the government, 1980 shares of population with high-school degree and college degree. The red lines correspond to a linear estimate of pre-treatment point estimates for event time -15 to -1 and is extended into the post-treatment periods.}
\end{figure}
...
\begin{subfigure}[b]{0.75\textwidth}
  ...
  \begin{adjustbox}{width=\textwidth, center}
  \includegraphics{plot_retail_many_estimators.pdf}
  \end{adjustbox}
\end{subfigure}
\end{center}
\begin{center}
\begin{subfigure}[b]{0.75\textwidth}
  ...
  \begin{adjustbox}{width=\textwidth, center}
  \includegraphics{plot_wholesale_many_estimators.pdf}
  \end{adjustbox}
\end{subfigure}
\end{center}
...
%   \caption{$\log$ Retail Employment}
%   \begin{adjustbox}{width=\textwidth, center}
%     \includegraphics{plot_synth_retail.pdf}
%   \end{adjustbox}
% \end{subfigure}
% \hfill
% \begin{subfigure}[b]{0.49\textwidth}
%   \caption{$\log$ Wholesale Retail Employment}
%   \begin{adjustbox}{width=\textwidth, center}
%     \includegraphics{plot_synth_wholesale.pdf}
%   \end{adjustbox}
% \end{subfigure}
% 
...
\note{This figure recreates estimates from panel (b) of \autoref{fig:walmart_retail} and \autoref{fig:walmart_wholesale} with confidence intervals formed ignoring the uncertainty deriving from first-stage estimates of $\theta$.}
\end{figure}
